...
<script>
export default {
  props: ['newRegister', 'register', 'changePage'],
  data () {
    return {
    }
  },
  methods: {
    checkPass: function () {
      console.log(this.newRegister.pass)
      if (this.newRegister.pass !== this.newRegister.conpass) {
        return alert('Your password is don\'t match, Please try again.')
      } else {
        this.register()
      }
    }
